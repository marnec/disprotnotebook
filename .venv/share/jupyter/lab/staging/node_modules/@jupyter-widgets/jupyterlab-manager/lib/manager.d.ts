...
export declare class WidgetManager extends ManagerBase<Widget> implements IDisposable {
    ...
    callbacks(view?: WidgetView): {
        iopub: {
            output: (msg: KernelMessage.IIOPubMessage<KernelMessage.IOPubMessageType>) => void;
        };
    };
    /**
    ...
    _handleKernelStatusChange(args: Kernel.Status): void;
    /**
     ...
     */
    readonly restoredStatus: boolean;
    /**
